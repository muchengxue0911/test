...
from fss.datasets.tps import random_tps_warp
...
class StaticTransformDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        classes = torch.tensor([[1]], dtype=torch.int64).reshape(1, 1)

        output = {'query_images': None, 'query_segmentations': None,
                  'support_images': images, 'support_segmentations': masks,
                  'query_classes': classes, 'support_classes': classes,
                  'identifier': f"class static, query 1"}
