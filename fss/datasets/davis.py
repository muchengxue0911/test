...
#         self.img_path = os.path.join(datapath, 'JPEGImages/480p/')
#         self.ann_path = os.path.join(datapath, 'Annotations/480p/')
...
#         support_names = [self.img_metadata_classwise[class_sample][0, self.shot]]
#
